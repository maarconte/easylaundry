...
add_action('wp_enqueue_scripts', 'yupeach_enqueue');
...
// use 'yupeach_load_ogtags(true)' to also display the og:image tag
function yupeach_ogtags() {
  echo '
